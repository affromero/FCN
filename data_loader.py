...
class Pascal_Data(VOCSegmentation):
    ...
    def __init__(self, root, image_set='train', backbone='vgg',
                 download=False):
        ...
        super(Pascal_Data, self).__init__(root,
                                          image_set=image_set,
...
def get_loader(opts):
    ...
    train_loader = data.DataLoader(Pascal_Data(opts.root_dataset,
                                               download=download,
                                               image_set=modes[0],
                                   ...
                                   shuffle=True,
                                   **kwargs)
    val_loader = data.DataLoader(Pascal_Data(opts.root_dataset,
                                             download=download,
                                             image_set=modes[1],
                                             backbone=opts.backbone),
                                 batch_size=1,
